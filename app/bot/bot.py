...
from app.bot.i18n.translator import get_translator
...
from app.bot.middlewares.shadow_ban import SwadowBanMiddleware
...
async def main(config: Config) -> None:
    ...
    dp.update.middleware(SwadowBanMiddleware())
